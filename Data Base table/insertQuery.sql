...
-- MASTER TABLES
SELECT * from goal_level;
SELECT * from goal_classification;
SELECT * from goal_quarter;
SELECT * from credit_point;
SELECT * from assignment_quality;
...
-- *please remove the null constraint of role in the user_role table*
...
INSERT INTO user_role(user_id,role_enum,created_by,last_modified_by) values(1,1,1,1);
INSERT INTO user_role(user_id,role_enum,created_by,last_modified_by) values(2,2,1,1);
INSERT INTO user_role(user_id,role_enum,created_by,last_modified_by) values(3,2,1,1);
INSERT INTO user_role(user_id,role_enum,created_by,last_modified_by) values(4,1,1,1);
INSERT INTO user_role(user_id,role_enum,created_by,last_modified_by) values(5,2,1,1);

---insert queries for stack_owner table---


INSERT INTO tech_stack(org_id,name,description,owner_id,tech_stack_status,created_by,last_modified_by) VALUES(1,'JAVA','JAVA JAVA JAVA',1,'Active',1,1);
INSERT INTO tech_stack(org_id,name,description,owner_id,tech_stack_status,created_by,last_modified_by) VALUES(1,'DOT NET','DOT NET JAVA JAVA',2,'Draft',1,1);
INSERT INTO tech_stack(org_id,name,description,owner_id,tech_stack_status,created_by,last_modified_by) VALUES(1,'HTML','JAVA JAVA JAVA',3,'Draft',1,1);
INSERT INTO tech_stack(org_id,name,description,owner_id,tech_stack_status,created_by,last_modified_by) VALUES(1,'CSS','JAVA JAVA JAVA',4,'Active',1,1);
INSERT INTO tech_stack(org_id,name,description,owner_id,tech_stack_status,created_by,last_modified_by) VALUES(1,'SALESFORCE','JAVA JAVA JAVA',5,'Active',1,1);
...
INSERT INTO goal(org_id  , tech_stack_id , goal_id , version , name , description , goal_status , level_id , is_deleted , credit_point_id , tags , goal_classification_id , other_prerequisite , esimated_effort ) 
VALUES(1 , 1 , 'JAVA.Basics.Intermediate.1' , 1 , 'Basics' , 'Basics of java' , 'Ready' , 1 , false , 1 , 'java' ,  1 ,'java java java' , 10.2  );

INSERT INTO goal(org_id  , tech_stack_id , goal_id , version , name , description , goal_status , level_id , is_deleted , credit_point_id , tags , goal_classification_id , other_prerequisite , esimated_effort ) 
VALUES(1 , 1 , 'JAVA.Advanced.Advanced.1' , 1 ,'Advanced' , 'Advanced Java' , 'In Review' , 1 , false , 1 , 'Advanced' ,  1 ,'java java java' , 12  );

INSERT INTO goal(org_id  , tech_stack_id , goal_id , version , name , description , goal_status , level_id , is_deleted , credit_point_id , tags , goal_classification_id , other_prerequisite , esimated_effort ) 
VALUES(1 , 2 , 'HTML.html.Beginner.1' , 1 , 'html' , 'Html tutorials' , 'In Review' , 1 , false , 1 , 'html',  1 , 'java java java' , 12  );


SELECT * FROM GOAL_MEMBER;
SELECT * FROM goal_prerequisite;
SELECT * FROM goal_chapter;
SELECT * FROM user_goal;
--Insert query for Goal member--

INSERT INTO goal_member(goal_id  , user_id , goal_role , created_by  , last_modified_by ) VALUES( 1 , 1 , 'COORDINATOR' , 1 , 1);
INSERT INTO goal_member(goal_id  , user_id , goal_role , created_by  , last_modified_by ) VALUES( 2 , 1 , 'EVALUATOR' , 1 , 1);
INSERT INTO goal_member(goal_id  , user_id , goal_role , created_by  , last_modified_by ) VALUES( 3 , 2 , 'COORDINATOR' , 1 , 1);
...
INSERT INTO user_goal(goal_id , user_id , quarter_id , user_goal_status_enum , is_deleted , approved_by , created_by , last_modified_by) VALUES
